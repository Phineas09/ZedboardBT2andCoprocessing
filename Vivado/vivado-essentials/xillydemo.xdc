...
set_property -dict "PACKAGE_PIN V7 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[48]"]; # "JD1_P" 
set_property -dict "PACKAGE_PIN W7 IOSTANDARD LVCMOS33" [get_ports "UART_0_txd"];  # "JD1_N" TXD  
set_property -dict "PACKAGE_PIN V5 IOSTANDARD LVCMOS33" [get_ports "UART_0_rxd"];  # "JD2_P" RXD

#set_property -dict "PACKAGE_PIN W7 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[49]"];  # "JD1_N" TXD  
#set_property -dict "PACKAGE_PIN V5 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[50]"];  # "JD2_P" RXD

set_property -dict "PACKAGE_PIN V4 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[49]"]; # "JD2_N"
set_property -dict "PACKAGE_PIN W6 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[50]"]; # "JD3_P"
set_property -dict "PACKAGE_PIN W5 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[51]"]; # "JD3_N"
set_property -dict "PACKAGE_PIN U6 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[52]"]; # "JD4_P"
set_property -dict "PACKAGE_PIN U5 IOSTANDARD LVCMOS33" [get_ports "PS_GPIO[53]"]; # "JD4_N"
