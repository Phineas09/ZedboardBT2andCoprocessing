...
architecture behav of scaled_fixed2ieee is 
    ...
    signal i_1_fu_298_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal i_1_reg_499 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_2_fu_206_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal trunc_ln510_fu_238_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_fu_251_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_242_p4 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal empty_31_fu_412_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    c_1_2_fu_284_p3 <= 
        ...
        c_1_019_reg_96;
    empty_31_fu_412_p1 <= newexp_fu_387_p2(8 - 1 downto 0);
    i_1_fu_298_p2 <= std_logic_vector(unsigned(i2_0_reg_141) + unsigned(ap_const_lv2_1));
    ...
    p_Result_22_fu_260_p3 <= 
        tmp_4_fu_251_p4 when (trunc_ln510_fu_238_p1(0) = '1') else 
        tmp_3_fu_242_p4;
    p_Result_23_fu_442_p4 <= ((ap_const_lv1_0 & out_exp_V_fu_434_p3) & significand_V_fu_426_p3);
    p_Result_s_fu_214_p5 <= (tmp_2_fu_206_p3 & ap_const_lv32_0(17 downto 0));
    ...
    tmp_2_fu_206_p3 <= (trunc_ln566_fu_202_p1 & ap_const_lv1_1);
    
    tmp_3_fu_242_p4_proc : process(out_bits_0_V_reg_467)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_3_fu_242_p4_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            ...
            for tmp_3_fu_242_p4_i in 0 to 32-1 loop
                v0_cpy(tmp_3_fu_242_p4_i) := out_bits_0_V_reg_467(32-1-tmp_3_fu_242_p4_i);
            end loop;
        end if;
        ...
        tmp_3_fu_242_p4 <= resvalue(32-1 downto 0);
    end process;

    
    tmp_4_fu_251_p4_proc : process(p_Result_s_reg_472)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_4_fu_251_p4_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_1F(5-1 downto 0)));
            for tmp_4_fu_251_p4_i in 0 to 32-1 loop
                v0_cpy(tmp_4_fu_251_p4_i) := p_Result_s_reg_472(32-1-tmp_4_fu_251_p4_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy), to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        tmp_4_fu_251_p4 <= resvalue(32-1 downto 0);
    end process;
