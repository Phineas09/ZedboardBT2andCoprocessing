...
// ==============================================================
#ifndef __xillybus_wrapper_mb6__HH__
#define __xillybus_wrapper_mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(xillybus_wrapper_mb6) {
    ...
    SC_CTOR(xillybus_wrapper_mb6):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
